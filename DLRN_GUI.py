...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        self.load_Files = QPushButton("Load custom model (optional)", self)
        self.load_Files.clicked.connect(self.load_custom_train_model)
    ...
    def load_custom_train_model(self):
